...
namespace WindowsFormsApplication1.Nhibernate
{
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "ornekdb");
        ...
        public static void Setup()
        {
            ...
            try
            {
                ...
                var mapping = GetMappings();
                NhConfiguration.AddDeserializedMapping(mapping, "ornekdb");
        ...
        {
            //log.Warn("Check DB");
            if (System.IO.File.Exists(exctLcl + "\\ornekdb.db")) return;
            SQLiteConnection.CreateFile(exctLcl + "\\ornekdb.db");
            using (var cn = new SQLiteConnection("Data Source=" + exctLcl + "\\ornekdb.db;Version=3;Password=;PRAGMA journal_mode=WAL;"))
            {
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=" + exctLcl + "//ornekdb.db;Version=3;PRAGMA journal_mode=WAL;";
            });
        ...
        protected static HbmMapping GetMappings()
        {
            ...
            mapper.AddMapping<Model.LokasyonMap>(); 
            mapper.AddMapping<Model.LokasyonMap>();
            mapper.AddMapping<Model.RezervasyonMap>();
